...
var buttonCounts = [button1count, button2count,
button3count, button4count, button5count, button6count];
...
  var userName =
prompt("Please enter your name", "User Name");
...
  var location =
prompt("Please enter your location", "Location");

  while (location ==
null) {

            var location = prompt("Please
enter your location", "Location");

  };

  var buttonNo =
prompt("Please enter the number of buttons you would like",
"1");
...
    var buttonname =
prompt("Please enter the name of button "+count, "Name");
...
            var
csvContent = "outputArray:text/csv;charset=utf-8,";

            outputArray.forEach(function(infoArray,
index){
...
            var
fileName = ("Survey of "+userInfo[1]+" by
"+userInfo[0]+".html");
